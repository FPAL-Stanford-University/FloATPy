...
class TestDifferentiatorCompact(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.der = CompactDifferentiator(self.grid_partition, (self.dx, self.dy, self.dz), self.order, 3, self.periodic)
    ...
    def testDivergence(self):
        ...
        myerror[0] = numpy.absolute(self.d2fdx2_exact + self.d2fdy2_exact + self.d2fdx2_exact - divergence).max()
