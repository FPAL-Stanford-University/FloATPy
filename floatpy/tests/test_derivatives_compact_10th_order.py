...
import floatpy.derivatives.compact.pycd10 as pycd10

class TestDerivativesCompact10th(unittest.TestCase):
    ...
    def testDerivativePeriodicX(self):
        ...
        der = pycd10.cd10stuff.cd10(self.nx, dx, periodic, 0, 0)     
        ...
        self.assertLess(error, 5.0e-14, "Incorrect periodic first derivative in X!")
    ...
    def testDerivativeNonperiodicX(self):
        ...
        error = numpy.absolute(dfdx_exact - dfdx).max()
        self.assertLess(error, 5.0e-5, "Incorrect non-periodic first derivative in X!")
    ...
    def testDerivativePeriodicY(self):
        ...
        der = pycd10.cd10stuff.cd10(self.ny, dy, periodic, 0, 0)     
        ...
        self.assertLess(error, 5.0e-14, "Incorrect periodic first derivative in Y!")
    ...
    def testDerivativeNonperiodicY(self):
        ...
        error = numpy.absolute(dfdy_exact - dfdy).max()
        self.assertLess(error, 5.0e-5, "Incorrect non-periodic first derivative in Y!")
    ...
    def testDerivativePeriodicZ(self):
        ...
        der = pycd10.cd10stuff.cd10(self.nz, dz, periodic, 0, 0)
        ...
        self.assertLess(error, 5.0e-14, "Incorrect periodic first derivative in Z!")
    ...
    def testDerivativeNonperiodicZ(self):
        ...
        error = numpy.absolute(dfdz_exact - dfdz).max()
        self.assertLess(error, 5.0e-5, "Incorrect non-periodic first derivative in Z!")
