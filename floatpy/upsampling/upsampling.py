...
def upsampleSecondOrderLagrange(data, refine_ratio, component_idx = 0):
    ...
    if dim == 1:
        ...
        if r[2] % 2 == 0: # If the upsampled nodes don't overlap with the original nodes.
            ...
            upsampled_data[start_idx_fine_0:end_idx_fine_0, start_idx_fine_1:end_idx_fine_1, start_idx_fine_2:end_idx_fine_2:r[2]] = \
                    upsampled_data_1[start_idx_fine_0:end_idx_fine_0, start_idx_fine_1:end_idx_fine_1, 0:(-stencil_size + 1)]
